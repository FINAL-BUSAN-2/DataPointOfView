    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <>
          ...
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <Text>태그</Text>
            <TouchableOpacity
              onPress={() => handleTagSelection('에너지 및 다량 영양소')}
              style={
            ...
            <TouchableOpacity
              onPress={() => handleTagSelection('비타민')}
              style={
                addtionEnabled === '비타민'
                  ? styles.selectedButton
                  : styles.button
            ...
            <TouchableOpacity
              onPress={() => handleTagSelection('무기질')}
              style={
                addtionEnabled === '무기질'
                  ? styles.selectedButton
                  : styles.button
      ...
      <View style={styles.addContainer}>
        <View style={styles.addTab}>
          <TouchableOpacity
            onPress={() => handleaddtionEnabled('추가할 카테고리')}>
